...
def get_token() -> Optional[str]:
    ...
    Returns:
        str or None: The Tushare API token if available, else None.
        No exception is raised - callers should check if token is None
        and fall back to public data sources (EastMoney).
    """
    _load_env_file()
...
def has_token() -> bool:
    """Check if Tushare Pro API token is available.
